...
local app = wibox.widget {
	...
	inputbox("Music Player", "music", user.music, "st -e ncmpcpp"),
	visible = false,
	spacing = dpi(15),
	layout = wibox.layout.fixed.vertical
}
...
local theme = wibox.widget {
	...
	inputbox("Font", "font", user.font, "cherry Regular 11"),
	inputbox("Alt Font", "fontalt", user.fontalt, "cherry Regular 11"),
